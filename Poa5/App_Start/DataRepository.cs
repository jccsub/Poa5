	...
	public class DataRepository
	{
		public static List<Post> Posts = new List<Post>()
		{
			new Post() {
				...
				URI = "https://chsakell.com/2015/08/23/building-single-page-applications-using-web-api-and-angularjs-free-e-book/",
			...
			new Post() {
				...
				Author = "Chris S.",
				AuthorGravatar = "http://1.gravatar.com/avatar/cb562a6de0640f743a272496ccfc210e",
				URI = "https://chsakell.com/2015/07/04/dependency-injection-in-wcf/",
			...
			new Post() {
				...
				Author = "Chris S.",
				AuthorGravatar = "http://1.gravatar.com/avatar/cb562a6de0640f743a272496ccfc210e",
				URI = "https://chsakell.com/2015/05/10/asp-net-web-api-unit-testing/",
			...
			new Post() {
				...
				Author = "Chris S.",
				AuthorGravatar = "http://1.gravatar.com/avatar/cb562a6de0640f743a272496ccfc210e",
				URI = "https://chsakell.com/2015/04/04/asp-net-web-api-feat-odata/",
			...
			new Post() {
				...
				Author = "Chris S.",
				AuthorGravatar = "http://1.gravatar.com/avatar/cb562a6de0640f743a272496ccfc210e",
				URI = "https://chsakell.com/2015/02/15/asp-net-mvc-solution-architecture-best-practices/",
